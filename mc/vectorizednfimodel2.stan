...
model {
	...
	// Likelihood. Tried to speed this up by getting rid of loop.
...
// Got rid of this to save time and because it didn't work
//generated quantities {
//	vector[N] log_lik; // Log-likelihood
//	log_lik <- normal_log(bainc, mu, sigma_i); // Also tried to speed this up by getting rid of the loop.
//}